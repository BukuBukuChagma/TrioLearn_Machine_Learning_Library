...
class Binary_Logistic_Regressor(Model):
  ...
  def __lowLevelFunction(self, trainingX, trainingY, testingX, testingY):
  ...
  def fit(self, trainX, trainY, testX, testY):
    self.__lowLevelFunction(trainX, trainY, testX, testY)
